<section>
    <div id="header2" class="main">
        ...
        <a class="faq-a" href="#a5">
            <p class="faq-p"> Does the Electoral College elect the president?</p>
        </a>
        ...
        <a class="faq-a" href="#b6">
            <p class="faq-p">Who chooses the members of the Electoral College?</p>
        </a>
        ...
        <a class="faq-a" href="#i6">
            <p class="faq-p" style="padding-bottom: 30px;">
        ...
        <h2 class="faq-h2" style="padding-top: 30px;">
            Electoral College
        </h2>
        ...
        <a class="faq-a" href="#header2">
            <p style="padding-bottom: 30px;">Return to Top</p>
        </a>
        <section>
            <div class="dividerwhite"></div>
        </section>
