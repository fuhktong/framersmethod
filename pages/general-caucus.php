<section>
    <div class="caucus-logo">
        <img src="/images/generalcaucuslogo.png" alt="The General Caucus" />
    </div>
    <?php include __DIR__ . '/../socialmediabar/socialmediabar.php'; ?>
    <section class="caucus-template" style="background-color: white;">
        <div class="caucus-template-text">
            <h1>The General Caucus</h1>
            <h2>
                A new election system designed to<br />
            ...
            <p>
                ...
                where registered voters gather to choose delegates for the
    ...
    <section class="caucus-template">
        <div class="caucus-template-text">
            <h1>Eliminates Money in Politics</h1>
            <h2>
                The General Caucus does not require<br />
                money to operate.
            </h2>
            <p>
        ...
        <div class="caucus-template-img">
            <img src="/images/moneyoutofpolitics.png" alt="Money Out of Politics" />
        </div>
    </section>
    ...
    <section class="caucus-template" style="background-color: white;">
        <div class="caucus-template-text">
            ...
            <h2>
                All office holders must come<br />
        ...
        <div class="caucus-template-img">
            <img src="/images/nopartiesimg.png" alt="No More Parties" />
        </div>
    </section>
    ...
    <section class="caucus-template">
        <div class="caucus-template-text">
            ...
            <p>
                This will increase voter independence as voters engage directly
                with each other rather than being manipulated by media narratives.
                So much of the media's influence revolves around very base issues
                and usually prioritizes sensationalism over substance.
            </p>
        </div>
        <div class="caucus-template-img">
            <img src="/images/nomedia.png" alt="Media Influence Mitigated" />
        </div>
    </section>
