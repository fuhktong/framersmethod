<footer>
    <div class="footer-title">
        <a href="/">
            <img src="/images/framersfooterlogo.png" alt="The Framers' Method" />
        </a>
    </div>
    ...
    <div class="footer-container">
        <div>
            <ul class="footer-links">
                <li>
                    <a class="link2" href="/general-caucus">GENERAL CAUCUS</a>
                </li>
                <li>
                    <a class="link2" href="/democracy-vs-republic">DEMOCRACY vs REPUBLIC</a>
                </li>
                <li>
                    <a class="link2" href="/hamilton-method">HAMILTON METHOD</a>
                </li>
                <li>
                    <a class="link2" href="/electors-convention">ELECTORS' CONVENTION</a>
                </li>
            </ul>
        </div>
        <div>
